  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-caption text-slate-400">Last 24 Hours</span>
      </div>
      ...
      <div className="grid grid-cols-12 gap-1 mb-4">
        {data.map((item) => (
          ...
          >
            <span className="text-[10px] font-medium text-slate-200">{item.hour}</span>

            {/* Tooltip */}
            <div className="absolute bottom-full mb-2 hidden group-hover:block z-10">
              <div className="bg-slate-900 border border-slate-700 rounded px-2 py-1 text-xs text-slate-50 whitespace-nowrap">
      ...
      {/* Peak Hours */}
      <div>
        <h4 className="text-body font-semibold text-slate-50 mb-2">Peak Hours</h4>
              ...
              <div className="flex items-center gap-3">
                <div className={`
                  ...
                  ${idx === 0 ? 'bg-purple-500 text-white' :
                    ...
                    'bg-purple-700/60 text-slate-200'}
                `}>
                  {idx + 1}
                </div>
                <span className="text-body text-slate-50 font-medium">{item.hour}:00</span>
              </div>
